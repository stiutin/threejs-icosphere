 ...
 *   BASE_URL=https://stiutin.github.io/threejs-icosphere/ npm run screenshots   # the live site
 *
...
const base = (live ?? 'http://localhost:4175/').replace(/\/?$/, '/');
...
await shoot({viewport: {width: 1440, height: 900}}, 'subdivided', async (page) => {
